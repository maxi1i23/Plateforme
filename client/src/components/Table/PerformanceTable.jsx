            ...
            <div className="overflow-x-auto">
                <table className="min-w-[600px] w-full">
                    <thead className="bg-gradient-to-r from-green-500/10 to-blue-500/10">
                        <tr>
                            <th className="px-4 py-3 text-left text-xs uppercase font-semibold text-gray-700">Semaine</th>
                            <th className="px-4 py-3 text-left text-xs uppercase font-semibold text-gray-700">Mois</th>
                            <th className="px-4 py-3 text-left text-xs uppercase font-semibold text-gray-700">Productivité</th>
                            {isAdmin && (
                                <th className="px-4 py-3 text-left text-xs uppercase font-semibold text-gray-700">Agent</th>
                            )}
                        </tr>
                    </thead>
